...
int UVCStatusCallback::setCallback(jobject status_callback_obj) {
...
void UVCStatusCallback::notifyStatusCallback(uvc_status_class status_class, int event, int selector,
...
void UVCStatusCallback::uvc_status_callback(uvc_status_class status_class, int event, int selector,
    ...
    statusCallback->notifyStatusCallback(status_class, event, selector, status_attribute, data, data_len);
