...
int UVCButtonCallback::setCallback(jobject button_callback_obj) {
...
void UVCButtonCallback::notifyButtonCallback(int button, int state) {
...
void UVCButtonCallback::uvc_button_callback(int button, int state, void *user_ptr) {
    ...
    buttonCallback->notifyButtonCallback(button, state);
